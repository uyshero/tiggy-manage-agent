...
function createClient(clientOptions) {
  ...
  async function coreFetch(schemaPath, fetchOptions) {
    ...
    if (response.status === 204 || request.method === "HEAD" || contentLength === "0" && !((_a = response.headers.get("Transfer-Encoding")) == null ? void 0 : _a.includes("chunked"))) {
  ...
  constructor(baseURL, options = {}) {
    ...
    __publicField(this, "fetch", async (input, init = {}) => {
      ...
      for (const [key, value] of new Headers(init.headers))
        headers.set(key, value);
      const token = this.staticToken || await ((_a = this.tokenSource) == null ? void 0 : _a.call(this, init.signal ?? void 0)) || "";
      if (token)
    ...
    this.staticToken = ((_a = options.token) == null ? void 0 : _a.trim()) ?? "";
...
function createAuthenticatedFetch(options = {}) {
  var _a;
  const baseURL = options.baseURL || ((_a = globalThis.location) == null ? void 0 : _a.origin) || "http://localhost";
  ...
  return async function authenticatedFetch(input, init) {
    ...
    if (location == null ? void 0 : location.assign) {
...
function createConsoleAPI(options = {}) {
  var _a;
  const configuredBaseURL = __vite_import_meta_env__ == null ? void 0 : __vite_import_meta_env__.VITE_TMA_API_BASE_URL;
  const baseURL = options.baseURL || configuredBaseURL || ((_a = globalThis.location) == null ? void 0 : _a.origin) || "http://localhost";
  const fetch2 = options.fetch || createAuthenticatedFetch({ baseURL });
  const service = new TMAClient(baseURL, { fetch: fetch2 }).tenantAdministration;
  return {
...
const getContext = api.getContext;
const listMembers = api.listMembers;
const saveMember = api.saveMember;
const removeMember = api.removeMember;
const listWorkspaces = api.listWorkspaces;
const createWorkspace = api.createWorkspace;
const listWorkspaceMembersAsPlatform = api.listWorkspaceMembersAsPlatform;
const saveWorkspaceMemberAsPlatform = api.saveWorkspaceMemberAsPlatform;
const removeWorkspaceMemberAsPlatform = api.removeWorkspaceMemberAsPlatform;
const listPlatformAdmins = api.listPlatformAdmins;
const savePlatformAdmin = api.savePlatformAdmin;
const removePlatformAdmin = api.removePlatformAdmin;
...
function Notice({ error, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "notice", role: "alert", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 17 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "关闭", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 16 }) })
  ] });
}
function Modal({ title, detail, children, onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-backdrop", role: "presentation", onMouseDown: (event) => event.target === event.currentTarget && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "modal", role: "dialog", "aria-modal": "true", "aria-label": title, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: title }),
        detail ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: detail }) : null
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "关闭", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 17 }) })
    ] }),
    children
  ] }) });
}
...
function MemberForm({ initial = emptyMember, lockedSubject = false, onCancel, onSubmit, busy }) {
  const [draft, setDraft] = reactExports.useState({ ...emptyMember, ...initial });
  const change = (key) => (event) => setDraft((value) => ({ ...value, [key]: event.target.value }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (event) => {
    event.preventDefault();
    onSubmit(draft);
  }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "用户标识", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, disabled: lockedSubject, value: draft.subject, onChange: change("subject"), placeholder: "OIDC subject" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "姓名", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: draft.display_name, onChange: change("display_name"), placeholder: "显示名称" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "邮箱", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", value: draft.email, onChange: change("email"), placeholder: "name@example.com" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Workspace 角色", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: draft.role, onChange: change("role"), children: Object.entries(roleLabels).map(([value, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value, children: label }, value)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "状态", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: draft.status, onChange: change("status"), children: Object.entries(statusLabels).map(([value, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value, children: label }, value)) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", onClick: onCancel, children: "取消" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", disabled: busy, type: "submit", children: [
        busy ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16 }),
        "保存"
      ] })
    ] })
  ] });
...
function WorkspaceMembers({ context, setError }) {
  ...
  const save = async (draft) => {
    setBusy(true);
    try {
      await saveMember(draft.subject.trim(), draft);
      setEditing(null);
      await load();
    } catch (error) {
      setError(error.message);
  ...
  const remove = async (member) => {
    ...
    try {
      await removeMember(member.subject);
      await load();
    } catch (error) {
      setError(error.message);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "content-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Workspace 成员" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "成员与角色仅在当前 Workspace 内生效。" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "刷新", onClick: load, disabled: loading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: loading ? "spin" : "", size: 17 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", onClick: () => setEditing(emptyMember), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "summary-strip", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: context.principal.workspace_id })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "成员数" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: members.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "当前身份" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: context.principal.username || context.principal.subject })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "成员" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "用户标识" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "角色" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "状态" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "更新时间" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { "aria-label": "操作" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: "6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "table-state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 20 }),
        "正在加载"
      ] }) }) }) : members.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: "6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-state", children: "暂无成员记录" }) }) }) : members.map((member) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "identity", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: (member.display_name || member.subject).slice(0, 1).toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: member.display_name || "未设置姓名" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: member.email || "未设置邮箱" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: member.subject }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `role role-${member.role}`, children: roleLabels[member.role] || member.role }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `status status-${member.status}`, children: statusLabels[member.status] || member.status }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: formatTime(member.updated_at) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "编辑成员", onClick: () => setEditing(member), children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCog, { size: 16 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "移除成员", disabled: member.subject === context.principal.subject, onClick: () => remove(member), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 16 }) })
        ] }) })
      ] }, member.subject)) })
    ] }) }),
    editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { title: editing.subject ? "编辑成员" : "添加成员", detail: `Workspace: ${context.principal.workspace_id}`, onClose: () => setEditing(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemberForm, { initial: editing, lockedSubject: !!editing.subject, onCancel: () => setEditing(null), onSubmit: save, busy }) }) : null
  ] });
}
function PlatformWorkspaces({ setError }) {
  ...
  if (selected) return /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformWorkspaceMembers, { workspace: selected, onBack: () => {
    setSelected(null);
    load();
  }, setError });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "content-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Workspace 租户" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "创建和查看平台上的租户边界。" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "刷新", onClick: load, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: loading ? "spin" : "", size: 17 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "inline-create", onSubmit: create, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 18 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, maxLength: "200", value: name, onChange: (event) => setName(event.target.value), placeholder: "Workspace 名称" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", disabled: creating || !name.trim(), children: [
        creating ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }),
        "创建"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "workspace-list", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "table-state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 20 }),
      "正在加载"
    ] }) : items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "workspace-row", onClick: () => setSelected(item), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "workspace-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 18 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function PlatformWorkspaceMembers({ workspace, onBack, setError }) {
  ...
  const load = reactExports.useCallback(async () => {
    setLoading(true);
    try {
      setMembers(await listWorkspaceMembersAsPlatform(workspace.id));
    } catch (error) {
      setError(error.message);
    } finally {
      setLoading(false);
  ...
  const save = async (draft) => {
    setBusy(true);
    try {
      await saveWorkspaceMemberAsPlatform(workspace.id, draft.subject.trim(), draft);
      setEditing(null);
      await load();
    } catch (error) {
      setError(error.message);
  ...
  const remove = async (member) => {
    ...
    try {
      await removeWorkspaceMemberAsPlatform(workspace.id, member.subject);
      await load();
    } catch (error) {
      setError(error.message);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "content-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "back-button", type: "button", onClick: onBack, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 16 }),
      "返回租户列表"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: workspace.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Platform Admin 正在管理目标 Workspace 的成员。" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "刷新", onClick: load, disabled: loading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: loading ? "spin" : "", size: 17 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", onClick: () => setEditing(emptyMember), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "summary-strip", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Workspace" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: workspace.id })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "成员数" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: members.length })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "管理范围" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Platform Admin" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: "6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "table-state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 20 }),
        "正在加载"
      ] }) }) }) : members.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: "6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-state", children: "暂无成员，请先配置 Workspace 管理员" }) }) }) : members.map((member) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "identity", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: (member.display_name || member.subject).slice(0, 1).toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: member.display_name || "未设置姓名" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "编辑成员", onClick: () => setEditing(member), children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCog, { size: 16 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "移除成员", onClick: () => remove(member), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 16 }) })
        ] }) })
      ] }, member.subject)) })
    ] }) }),
    editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { title: editing.subject ? "编辑租户成员" : "添加租户成员", detail: `Workspace: ${workspace.id}`, onClose: () => setEditing(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemberForm, { initial: editing, lockedSubject: !!editing.subject, onCancel: () => setEditing(null), onSubmit: save, busy }) }) : null
  ] });
}
function PlatformAdmins({ context, setError }) {
  const [items, setItems] = reactExports.useState([]);
  const [editing, setEditing] = reactExports.useState(false);
  const [draft, setDraft] = reactExports.useState(emptyAdmin);
  const [busy, setBusy] = reactExports.useState(false);
  const load = reactExports.useCallback(async () => {
    try {
      setItems(await listPlatformAdmins());
    } catch (error) {
      setError(error.message);
    }
  }, [setError]);
  ...
  const save = async (event) => {
    ...
    setBusy(true);
    try {
      await savePlatformAdmin(draft.subject.trim(), draft);
      setEditing(false);
      setDraft(emptyAdmin);
      await load();
    } catch (error) {
  ...
  const remove = async (item) => {
    if (!window.confirm(`移除平台管理员 ${item.display_name || item.subject}？`)) return;
    try {
      await removePlatformAdmin(item.subject);
      await load();
    } catch (error) {
      setError(error.message);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "content-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Platform Admin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "平台角色不属于任何单个 Workspace。" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", onClick: () => setEditing(true), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }),
        "添加管理员"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "admin-grid", children: items.length ? items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "admin-item", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "identity", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 17 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: item.display_name || item.subject }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: item.email || item.subject })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { label: "移除平台管理员", disabled: item.subject === context.principal.subject, onClick: () => remove(item), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 16 }) })
    ] }, item.subject)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-state", children: "尚无持久化的平台管理员" }) }),
    editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { title: "添加 Platform Admin", detail: "该角色可以管理所有 Workspace 租户。", onClose: () => setEditing(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: save, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "用户标识", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, value: draft.subject, onChange: (event) => setDraft({ ...draft, subject: event.target.value }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "姓名", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: draft.display_name, onChange: (event) => setDraft({ ...draft, display_name: event.target.value }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "邮箱", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", value: draft.email, onChange: (event) => setDraft({ ...draft, email: event.target.value }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", onClick: () => setEditing(false), children: "取消" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", disabled: busy, children: [
          busy ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16 }),
          "保存"
        ] })
      ] })
...
function App() {
  ...
  const [active, setActive] = reactExports.useState("members");
  const [error, setError] = reactExports.useState("");
  reactExports.useEffect(() => {
    getContext().then(setContext).catch((loadError) => setError(loadError.message));
  }, []);
  const nav = reactExports.useMemo(() => {
    const items = [];
    if (context == null ? void 0 : context.workspace_admin) items.push({ id: "members", label: "成员与角色", detail: "当前 Workspace", icon: Users });
    if (context == null ? void 0 : context.platform_admin) items.push({ id: "workspaces", label: "租户管理", detail: "Platform Admin", icon: Building2 }, { id: "admins", label: "平台管理员", detail: "Platform Admin", icon: ShieldCheck });
    return items;
  }, [context]);
  if (!context) return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "boot", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "brand-mark", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 24 }) }),
    error ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Console 无法加载" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: error })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "spin", size: 20 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "正在加载管理上下文" })
    ] })
  ] });
  const selected = nav.some((item) => item.id === active) ? active : ((_a = nav[0]) == null ? void 0 : _a.id) || "";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "topbar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brand", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "brand-mark", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 19 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "TMA Console" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "管理中心" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "principal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: context.principal.username || context.principal.subject }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: context.principal.workspace_id })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "avatar", children: (context.principal.username || context.principal.subject).slice(0, 1).toUpperCase() })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "layout", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scope-label", children: "Workspace" }),
        nav.map(({ id, label, detail, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: selected === id ? "nav-item active" : "nav-item", onClick: () => setActive(id), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Notice, { error, onClose: () => setError("") }),
        selected === "members" ? /* @__PURE__ */ jsxRuntimeExports.jsx(WorkspaceMembers, { context, setError }) : selected === "workspaces" ? /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformWorkspaces, { setError }) : selected === "admins" ? /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformAdmins, { context, setError }) : /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "content-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-state", children: "当前身份没有 Console 管理权限" }) })
      ] })
    ] })
  ] });
}
