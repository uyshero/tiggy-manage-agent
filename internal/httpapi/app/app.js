      ...
      ctor.then(
        function(moduleObject) {
          if (0 === payload2._status || -1 === payload2._status)
            payload2._status = 1, payload2._result = moduleObject;
        },
        function(error) {
          if (0 === payload2._status || -1 === payload2._status)
            payload2._status = 2, payload2._result = error;
        }
      );
      -1 === payload2._status && (payload2._status = 0, payload2._result = ctor);
    }
    if (1 === payload2._status) return payload2._result.default;
...
function requireReactDomClient_production() {
  ...
  function runActionStateAction(actionQueue, node) {
    ...
    if (node.isTransition) {
      ...
      try {
        prevTransition = action(prevState, payload2), handleActionReturnValue(actionQueue, node, prevTransition);
      } catch (error$66) {
  ...
  function useEffectEventImpl(payload2) {
    ...
    if (null === componentUpdateQueue)
      ...
      null === events2 ? componentUpdateQueue.events = [payload2] : events2.push(payload2);
    }
  }
  ...
  var classComponentUpdater = {
    enqueueSetState: function(inst, payload2, callback) {
      ...
      null !== payload2 && (scheduleUpdateOnFiber(payload2, inst, lane), entangleTransitions(payload2, inst, lane));
    },
...
function sendSessionMessage(sessionId, text, options = {}) {
...
function TaskStatusIcon({ status }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", className: `task-status-icon ${status || "unknown"}` });
}
function ArchiveIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { "aria-hidden": "true", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 3.5h10l-1 2H4l-1-2Zm1 3h8v5.5H4V6.5Zm2 2h4", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.4" }) });
}
function DeleteIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { "aria-hidden": "true", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5.5 4.5h5m-4-1.5h3m-4 3v6h5v-6m-7-1.5h9", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.4" }) });
}
...
function toolRisk(identifier, apiName, reason = "") {
  const api2 = String(apiName || "");
  const riskReason = String(reason || "");
  if (riskReason.includes("network") || ["run_command", "execute_code", "write_file", "edit_file", "click", "type_text", "hotkey", "launch_app", "open_url"].includes(api2)) {
    return "high";
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `approval-card risk-${summary.risk}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "approval-card-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: summary.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Meta, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: summary.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { value: intervention.status || "pending" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `risk-chip ${summary.risk}`, children: [
            summary.risk,
            " risk"
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "approval-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: busy, onClick: () => onApprove(intervention), children: busy ? "Approving..." : "Approve" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", disabled: busy, onClick: () => onReject(intervention), children: "Reject" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "approval-details", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: "Arguments" }),
...
function cleanMessageText(text) {
  return messageParts(text).filter((part) => part.type === "text").map((part) => part.text).join("\n").trim();
}
...
function activityView(event) {
  ...
  switch (event == null ? void 0 : event.type) {
    ...
    case "runtime.tool_result": {
      ...
      const detail = data.success === false ? data.error || data.message || "The tool returned an error." : artifactCount ? `${artifactCount} result file${artifactCount === 1 ? "" : "s"} generated.` : summary.detail;
    ...
    default:
      return { title: (event == null ? void 0 : event.type) || "Activity", detail: turnActivityLabel(event) || eventText(event), kind: "muted" };
  }
}
...
function previewKindForArtifact(artifact, contentType = "") {
  ...
  if (type.startsWith("text/") || type.includes("json") || type.includes("xml") || ["txt", "md", "markdown", "json", "jsonl", "csv", "tsv", "log", "xml", "html", "css", "js", "jsx", "ts", "tsx", "go", "py", "sh", "yaml", "yml"].includes(extension)) {
    return "text";
  }
  return "download";
}
...
function turnSignal(events2, options = {}) {
  ...
  const interventions2 = options.interventions || [];
  const currentEvents = (events2 || []).filter((event) => Number(event.seq || 0) > sinceSeq);
  ...
  const failureEvent = reverseEvents.find(
    (event) => event.type === "runtime.failed" || event.type === "session.status_idle" && payload(event).last_turn_status === "failed" || event.type === "session.status_failed"
  );
...
function ToolActionCard({ tool }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `tool-action-card risk-${summary.risk}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tool-action-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: summary.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Meta, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: summary.label || tool.rawName }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `risk-chip ${summary.risk}`, children: [
            summary.risk,
            " risk"
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tool-action-status", children: "Prepared" })
    ] }),
    summary.detail ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tool-action-detail", children: summary.detail }) : null,
    Object.keys(tool.args || {}).length ? /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "tool-action-details", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: "Details" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { children: pretty(tool.args) })
    ] }) : null
  ] });
}
function ProcessEventCard({ event }) {
  ...
  if (event.type === "runtime.tool_call") {
    ...
    preview = data.success === false ? error.message || data.message || "The tool returned an error." : shortText(data.content || summary.detail || "", 240) || (artifacts2.length ? `${artifacts2.length} artifact${artifacts2.length === 1 ? "" : "s"} generated.` : "Tool finished successfully.");
    detailObject = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: `process-card ${tone}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "process-card-head", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Meta, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: metaLabel }),
    ...
    detailObject ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "process-card-detail", children: pretty(detailObject) }) : null
  ] });
}
function MessageBody({ event }) {
  ...
  if (!parts.length || parts.length === 1 && parts[0].type === "text" && !parts[0].text) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-text", children: "（空消息）" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-body", children: parts.map((part, index) => part.type === "tool" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ToolActionCard, { tool: part.tool }, `tool-${index}`) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-text", children: part.text }, `text-${index}`)) });
}
...
function WorkbenchApp() {
  ...
  const [waitingForReply, setWaitingForReply] = reactExports.useState(false);
  const [recentSessions, setRecentSessions] = reactExports.useState([]);
  const [decidingApprovalID, setDecidingApprovalID] = reactExports.useState("");
  const [sessionAction, setSessionAction] = reactExports.useState("");
  ...
  const artifactPreviewURLRef = reactExports.useRef("");
  const artifactPreviewRequestRef = reactExports.useRef(0);
  const threadRef = reactExports.useRef(null);
  const shouldAutoScrollRef = reactExports.useRef(true);
  const pendingApprovalCountRef = reactExports.useRef(0);
  const scrollFrameRef = reactExports.useRef(0);
  reactExports.useEffect(() => {
    document.title = "TMA Workbench";
    let active = true;
    async function restoreRecentSession() {
      setStatus("loading history");
      const response = await sessions({ limit: 30 });
      if (!active) return;
      const sessions$1 = response.sessions || [];
      setRecentSessions(sessions$1);
      const remembered = rememberedSessionID();
      const selected = sessions$1.find((session2) => session2.id === remembered) || sessions$1[0];
      if (!selected) {
  ...
  async function loadPreSessionDefaults() {
    const [defaultAgent$1, providersResponse] = await Promise.all([
      defaultAgent(),
      llmProviders()
    ]);
    ...
    const options = enabledProviders.flatMap((provider, index) => (modelResponses[index].models || []).map((model) => ({
      label: `${provider.id} / ${model.model}`,
      llmModel: model.model,
      llmProvider: provider.id
    })));
    setDefaultAgentConfig(defaultAgent$1);
    setModelOptions(options);
    setSettingsDraft((current) => {
      var _a2, _b;
      return {
        ...current,
        llmModel: current.llmModel || ((_a2 = defaultAgent$1.config_version) == null ? void 0 : _a2.llm_model) || "",
        llmProvider: current.llmProvider || ((_b = defaultAgent$1.config_version) == null ? void 0 : _b.llm_provider) || "",
        toolRuntime: current.toolRuntime || "cloud_sandbox"
      };
    });
  }
  const events$1 = eventsResponse.events || [];
  reactExports.useMemo(() => events$1.filter((event) => event.type === "user.message" || event.type === "agent.message").sort((left, right) => Number(left.seq || 0) - Number(right.seq || 0)), [events$1]);
  const chatTimelineEvents = reactExports.useMemo(() => events$1.filter((event) => [
    "user.message",
    "agent.message",
    "runtime.tool_call",
    "runtime.tool_result",
    ...
    "runtime.tool_intervention_approved",
    "runtime.tool_intervention_rejected"
  ].includes(event.type)).sort((left, right) => Number(left.seq || 0) - Number(right.seq || 0)), [events$1]);
  const interventions$1 = interventionResponse.interventions || [];
  const artifacts$1 = artifactResponse.artifacts || [];
  const lastUserSeq = reactExports.useMemo(() => {
  ...
  const liveSignal = reactExports.useMemo(() => turnSignal(events$1, {
    ...
    sessionStatus: sessionMeta == null ? void 0 : sessionMeta.status,
    waitingForReply,
    interventions: interventions$1,
    includeSuccess: waitingForReply
  }), [events$1, interventions$1, lastUserSeq, sessionMeta == null ? void 0 : sessionMeta.status, waitingForReply]);
  const runState = reactExports.useMemo(() => {
    if (interventions$1.length) return "waiting approval";
    if ((liveSignal == null ? void 0 : liveSignal.kind) === "thinking") return "running";
    if ((liveSignal == null ? void 0 : liveSignal.kind) === "success") return "completed";
    if ((liveSignal == null ? void 0 : liveSignal.kind) === "error") return "failed";
    if (sessionMeta == null ? void 0 : sessionMeta.status) return sessionMeta.status;
    return sessionID ? "active" : "not started";
  }, [interventions$1.length, liveSignal == null ? void 0 : liveSignal.kind, sessionID, sessionMeta == null ? void 0 : sessionMeta.status]);
  ...
  const filteredTaskSessions = reactExports.useMemo(() => {
    ...
    const matches = recentSessions.filter((session2) => {
      if (!query) return true;
      const title = String(session2.title || "").toLowerCase();
      const id = String(session2.id || "").toLowerCase();
  ...
  const visibleTaskSessions = reactExports.useMemo(() => {
  ...
  async function loadSessionSettings(value, sessionValue = sessionMeta) {
    ...
    const [config, capabilities, providersResponse] = await Promise.all([
      sessionRuntimeConfig(nextSessionID),
      sessionRuntimeCapabilities(nextSessionID),
      llmProviders()
    ]);
    const enabledProviders = (providersResponse.providers || []).filter((provider) => provider.enabled !== false);
    const modelResponses = await Promise.all(enabledProviders.map((provider) => llmModels(provider.id).catch(() => ({ models: [] }))));
  ...
  reactExports.useEffect(() => {
    ...
    if (!liveSignal) {
      if ((sessionMeta == null ? void 0 : sessionMeta.status) === "failed") {
  ...
  }, [waitingForReply, liveSignal, sessionMeta == null ? void 0 : sessionMeta.status]);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    if (hasPendingApprovals && interventions$1.length > pendingApprovalCountRef.current) {
      setApprovalsOpen(true);
    }
    if (!hasPendingApprovals) {
      setApprovalsOpen(false);
    }
    pendingApprovalCountRef.current = interventions$1.length;
  }, [hasPendingApprovals, interventions$1.length]);
  ...
  async function startSession() {
    ...
    const agent = agentID.trim() ? { id: agentID.trim() } : defaultAgentConfig || await defaultAgent();
    ...
    if (shouldApplyInitialSettings) {
      const updatedSession = await updateSessionRuntimeSettings(session2.id, {
        ...
        llm_model: settingsDraft.llmModel || ((_a2 = agent.config_version) == null ? void 0 : _a2.llm_model) || "",
        llm_provider: settingsDraft.llmProvider || ((_b = agent.config_version) == null ? void 0 : _b.llm_provider) || "",
    ...
    if (task.trim()) {
      await sendTask(session2.id);
    } else {
      await refresh(session2.id);
    }
  }
  async function sendTask(nextSessionID = sessionID) {
    ...
    const queued = Boolean(waitingForReply || (sessionMeta == null ? void 0 : sessionMeta.status) === "running" || (sessionMeta == null ? void 0 : sessionMeta.status) === "interrupting");
    setStatus(queued ? "queued message" : "sending task");
    const response = await sendSessionMessage(value, text, { preferLatest: false });
  ...
  async function archiveTask(targetSessionID) {
    ...
    setStatus("archiving");
    try {
      const archived = await archiveSession(nextSessionID);
  ...
  async function previewArtifact(artifact) {
    ...
    try {
      const response = await getBlob(artifactDownloadPath(sessionID, artifact.id));
      ...
      if (kind === "text") {
        ...
        const truncated = text.length > 64e3;
        setArtifactPreview({
          artifact,
          status: "ready",
          kind,
          contentType,
          text: truncated ? `${text.slice(0, 64e3)}
...
[Preview truncated]` : text
  ...
  function startNewTask() {
    ...
    setSettingsDraft({
      interventionMode: "request_approval",
      llmModel: ((_a2 = defaultAgentConfig == null ? void 0 : defaultAgentConfig.config_version) == null ? void 0 : _a2.llm_model) || "",
      llmProvider: ((_b = defaultAgentConfig == null ? void 0 : defaultAgentConfig.config_version) == null ? void 0 : _b.llm_provider) || "",
      toolRuntime: "cloud_sandbox"
    });
    setApprovalsOpen(false);
    setStatus("ready");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "user-app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "user-topbar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "topbar-brand", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "topbar-label", children: "TMA Workbench" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "topbar-context", children: (sessionMeta == null ? void 0 : sessionMeta.title) || sessionID || "General agent workspace" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "user-layout", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "user-sidebar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Workspace", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stack", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: startNewTask, children: "New Task" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Tasks", className: "tasks-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stack task-panel-content", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-section-list task-section-scroll", children: [
            filteredTaskSessions.length ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "task-section-title", children: "All tasks" }),
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        type: "button",
                        title: session2.title || "Untitled task",
                        onClick: () => openSession(session2).catch((error) => setStatus(error.message)),
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-nav-row", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TaskStatusIcon, { status: session2.status }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: session2.title || "Untitled task" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "task-nav-time", children: formatTaskTime(session2.created_at) })
                        ] })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-inline-actions", children: [
                      session2.status !== "terminated" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          title: "Archive",
                          "aria-label": "Archive",
                          disabled: sessionAction === `archive:${session2.id}`,
                          onClick: () => archiveTask(session2.id).catch((error) => setStatus(error.message)),
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveIcon, {})
                        }
                      ) : null,
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          title: "Delete",
                          "aria-label": "Delete",
                          disabled: sessionAction === `delete:${session2.id}`,
                          onClick: () => deleteTask(session2.id).catch((error) => setStatus(error.message)),
              ...
              hasMoreTasks ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary task-more-button", type: "button", onClick: () => setVisibleTaskCount((current) => current + 10), children: "Show more tasks" }) : null
            ] }) : null,
            !filteredTaskSessions.length ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: hasTaskSearch ? "No tasks match your search." : "No tasks yet." }) : null
          ] })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "user-main", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "user-thread", onScroll: handleThreadScroll, ref: threadRef, children: [
          hasPendingApprovals ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "approval-alert", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setApprovalsOpen(true), children: "Review" })
          ] }) : null,
          chatTimelineEvents.length ? chatTimelineEvents.map((event) => {
            if (event.type === "user.message" || event.type === "agent.message") {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `message ${role}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Meta, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: role === "user" ? "你" : "通用智能体" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTime(event.created_at) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageBody, { event })
              ] }, `${event.seq}-${event.type}`);
            }
            return /* @__PURE__ */ jsxRuntimeExports.jsx(ProcessEventCard, { event }, `${event.seq}-${event.type}`);
          }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-state", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-hero", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "welcome-eyebrow", children: "Managed Agent Workspace" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Start a task and let the general agent move it forward." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "TMA can inspect code, run checks, edit files, use tools, and keep a session moving until the work is done. Pick a starting point below or type your own request." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-tags", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Code review" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "File edits" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Build and test" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Tool orchestration" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "starter-grid", children: starterTasks.map((starter) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "starter-card", type: "button", onClick: () => setTask(starter.prompt), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: starter.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: starter.detail })
            ] }, starter.title)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-note", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Tip" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "You can preselect the model, approval mode, and runtime before the task starts." })
            ] })
          ] }),
          waitingForReply ? /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "message agent pending", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Meta, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "通用智能体" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-text", children: "正在思考并生成回复…" })
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "composer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-shell", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: task, onChange: (event) => setTask(event.target.value), placeholder: "Ask TMA to build, inspect, edit, or run something..." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-footer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-settings-inline", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "composer-setting", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Approval" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "request_approval", children: "Ask first" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "approve_for_me", children: "Approve for me" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "full_access", children: "Full access" })
                    ]
                  }
                )
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-actions-inline", children: [
              waitingForReply && !hasPendingApprovals ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "subtle", children: "New messages will queue behind the current run." }) : !sessionID ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "subtle", children: "Current selections will be applied when the task starts." }) : null,
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: hasPendingApprovals, onClick: () => sessionID ? sendTask().catch((error) => setStatus(error.message)) : startSession().catch((error) => setStatus(error.message)), children: sendButtonLabel })
            ] })
          ] })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "user-sidebar right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Activity", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list activity-list", children: activityEvents.length ? activityEvents.map((item) => {
        ...
        }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "No runtime activity yet." }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "Artifacts", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list", children: artifacts$1.length ? artifacts$1.map((artifact) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "list-item", children: [
              ...
              artifact.description ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "subtle", children: artifact.description }) : null,
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "artifact-actions", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", disabled: previewKind === "download", onClick: () => previewArtifact(artifact).catch((error) => setStatus(error.message)), children: "Preview" }),
          ...
          artifactPreview ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "artifact-preview", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "artifact-preview-header", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: artifactName(artifactPreview.artifact) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "subtle", children: artifactPreview.contentType || ((_a = artifactPreview.artifact) == null ? void 0 : _a.artifact_type) || "artifact" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", onClick: clearArtifactPreview, children: "Close" })
            ] }),
            artifactPreview.status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "Loading preview..." }) : null,
            artifactPreview.status === "error" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "artifact-preview-error", children: artifactPreview.error }) : null,
            artifactPreview.status === "ready" && artifactPreview.kind === "image" ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "preview-media", src: artifactPreview.objectUrl, alt: artifactName(artifactPreview.artifact) }) : null,
            artifactPreview.status === "ready" && artifactPreview.kind === "text" ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "artifact-preview-text", children: artifactPreview.text || "" }) : null
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Session", children: sessionMeta ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stack", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Meta, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: sessionMeta.id }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { value: sessionMeta.status || "unknown" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: sessionMeta.title || "Untitled session" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { children: pretty(sessionMeta.runtime_settings || {}) })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { children: "No session loaded." }) })
      ] })
    ] }),
    approvalsOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "approval-modal-backdrop", role: "presentation", onClick: () => setApprovalsOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "approval-modal", role: "dialog", "aria-modal": "true", "aria-label": "Approvals", onClick: (event) => event.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "approval-modal-header", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "approval-modal-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", onClick: () => refresh().catch((error) => setStatus(error.message)), children: "Refresh" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "secondary", type: "button", onClick: () => setApprovalsOpen(false), children: "Close" })
        ] })
      ] }),
...
clientExports.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(WorkbenchApp, {}));
