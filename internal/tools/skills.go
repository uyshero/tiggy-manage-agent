	...
	return Manifest{
		...
		API: []API{
			...
			},
			{
				...
				Parameters:  json.RawMessage(`{"type":"object","properties":{"identifier":{"type":"string"},"version":{"type":"integer","minimum":1},"path":{"type":"string"}},"required":["identifier","path"]}`),
				Risk:        ToolRiskRead, Runtime: runtimePolicy, Implementation: ToolImplementationServerBuiltin,
			},
			{
				...
				HumanIntervention: "Installing or upgrading a skill changes the workspace registry.",
			...
			},
			{
				...
				HumanIntervention: "Enabling a skill changes the Agent configuration used by future or upgraded Sessions.",
				Risk:              ToolRiskWrite, Runtime: runtimePolicy, Implementation: ToolImplementationServerBuiltin,
			},
			{
				...
				HumanIntervention: "Disabling a skill changes the Agent configuration used by future or upgraded Sessions.",
				Risk:              ToolRiskWrite, Runtime: runtimePolicy, Implementation: ToolImplementationServerBuiltin,
			},
		},
	}
