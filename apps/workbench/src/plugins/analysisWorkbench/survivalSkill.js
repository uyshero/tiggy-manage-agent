export const R_SURVIVAL_DATA_CLEANING_SKILL_PATH = "skills/r-survival-data-cleaning/SKILL.md";

export const R_SURVIVAL_DATA_CLEANING_SKILL_CONTENT = `# R 生存分析数据清洗 Skill
