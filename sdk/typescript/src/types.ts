...
export type UpsertWorkspaceMembershipRequest = Schema["UpsertWorkspaceMembershipRequest"];
export type PlatformRoleAssignment = Schema["PlatformRoleAssignment"];
export type UpsertPlatformAdminRequest = Schema["UpsertPlatformAdminRequest"];
export type TenantWorkspace = Schema["TenantWorkspace"];
export type CreateTenantWorkspaceRequest = Schema["CreateTenantWorkspaceRequest"];
export type ServiceIdentity = Schema["ServiceIdentity"];
export type CreateServiceIdentityRequest = Schema["CreateServiceIdentityRequest"];
export type UpdateServiceIdentityRequest = Schema["UpdateServiceIdentityRequest"];
...
export type RunComparison = Schema["RunComparison"];
export type EvaluationCriterion = Schema["EvaluationCriterion"];
export type EvaluationRubric = Schema["EvaluationRubric"];
export type CreateEvaluationRubricRequest = Schema["CreateEvaluationRubricRequest"];
export type EvaluationCriterionScore = Schema["EvaluationCriterionScore"];
export type EvaluationRubricSnapshot = Schema["EvaluationRubricSnapshot"];
export type RunEvaluation = Schema["RunEvaluation"];
export type CreateRunEvaluationRequest = Schema["CreateRunEvaluationRequest"];
export type AutoRunEvaluationRequest = Schema["AutoRunEvaluationRequest"];
export type EvaluationDatasetItem = Schema["EvaluationDatasetItem"];
export type EvaluationDataset = Schema["EvaluationDataset"];
export type CreateEvaluationDatasetItemRequest = Schema["CreateEvaluationDatasetItemRequest"];
export type CreateEvaluationDatasetRequest = Schema["CreateEvaluationDatasetRequest"];
export type EvaluationExperimentItem = Schema["EvaluationExperimentItem"];
export type EvaluationExperimentSummary = Schema["EvaluationExperimentSummary"];
export type EvaluationExperiment = Schema["EvaluationExperiment"];
export type CreateEvaluationExperimentRequest = Schema["CreateEvaluationExperimentRequest"];
...
export type RetrievalCollection = Schema["RetrievalCollection"];
export type CreateRetrievalCollectionRequest = Schema["CreateRetrievalCollectionRequest"];
export type RetrievalDocument = Schema["RetrievalDocument"];
export type RetrievalDocumentUploadResult = Schema["RetrievalDocumentUploadResult"];
export type RetrievalIngestionJob = Schema["RetrievalIngestionJob"];
export type RetrievalSearchRequest = Schema["RetrievalSearchRequest"];
export type RetrievalSearchResult = Schema["RetrievalSearchResult"];
...
export type ModelEmbeddingRequest = Schema["ModelEmbeddingRequest"];
export type ModelEmbedding = Schema["ModelEmbedding"];
export type ModelEmbeddingResponse = Schema["ModelEmbeddingResponse"];
export type ModelRerankRequest = Schema["ModelRerankRequest"];
export type ModelRerankResult = Schema["ModelRerankResult"];
export type ModelRerankResponse = Schema["ModelRerankResponse"];
export type ModelInvocation = Schema["ModelInvocation"];
export type ModelInvocationSummary = Schema["ModelInvocationSummary"];
export type ModelInvocationReport = Schema["ModelInvocationReport"];
export interface ModelInvocationQuery {
  principalId?: string;
  serviceIdentityId?: string;
  capability?: ModelInvocation["capability"];
  providerId?: string;
  model?: string;
...
export type ToolPermissionAuditRecord = Schema["ToolPermissionAuditRecord"];
export type ToolPermissionAuditPage = Schema["ToolPermissionAuditList"];
...
export type WorkspacePermissionRule = Schema["WorkspacePermissionRule"];
export type UpdateWorkspaceToolPermissionPolicyRequest = Schema["UpdateWorkspaceToolPermissionPolicyRequest"];
export type WorkspaceToolPermissionPolicy = Schema["WorkspaceToolPermissionPolicy"];
export type EvaluateWorkspaceToolPermissionRequest = Schema["EvaluateWorkspaceToolPermissionRequest"];
export type EvaluateWorkspaceToolPermissionResult = Schema["EvaluateWorkspaceToolPermissionResult"];
