...
import { ApplicationManifestsService } from "./services/application-manifests.js";
...
import { ArtifactExchangesService } from "./services/artifact-exchanges.js";
import { AuthService } from "./services/auth.js";
import { CapabilitiesService } from "./services/capabilities.js";
import { QuotaPoliciesService } from "./services/quota-policies.js";
import { EnvironmentsService } from "./services/environments.js";
import { EvaluationsService } from "./services/evaluations.js";
import { EventSubscriptionsService } from "./services/event-subscriptions.js";
...
export class TMAClient {
  ...
  readonly quotaPolicies: QuotaPoliciesService;
  readonly applicationManifests: ApplicationManifestsService;
  readonly agents: AgentsService;
  readonly environments: EnvironmentsService;
  readonly sessions: SessionsService;
  readonly evaluations: EvaluationsService;
  readonly eventSubscriptions: EventSubscriptionsService;
  readonly runs: RunsService;
  readonly interventions: InterventionsService;
  readonly artifacts: ArtifactsService;
  readonly artifactExchanges: ArtifactExchangesService;
  ...
  constructor(baseURL: string, options: TMAClientOptions = {}) {
    ...
    this.quotaPolicies = new QuotaPoliciesService(transport);
